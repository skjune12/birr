...
const SimpleStorageBin = ``
...
func (_SimpleStorage *SimpleStorageCaller) StoredData(opts *bind.CallOpts) (string, error) {
	var (
		ret0 = new(string)
	)
	out := ret0
...
//
// Solidity: function storedData() constant returns(string)
func (_SimpleStorage *SimpleStorageSession) StoredData() (string, error) {
...
//
// Solidity: function storedData() constant returns(string)
func (_SimpleStorage *SimpleStorageCallerSession) StoredData() (string, error) {
	return _SimpleStorage.Contract.StoredData(&_SimpleStorage.CallOpts)
}
